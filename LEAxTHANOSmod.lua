...
-- TAM EKRAN | HACKER TEMASI | LINE-ART HAMSTER
-- ============================================================
...
-- ============================================================
-- LINE-ART HAMSTER OLUŞTUR (Gerçek çizgi hamster)
-- ============================================================
local function CreateLineArtHamster(parent, size, position, isSmall)
    ...
    for i = 0, 1 do
        ...
        eye.Size = UDim2.new(0.08, 0, 0.08, 0)
        eye.Position = UDim2.new(0.25 + (i * 0.38), 0, 0.35, 0)
        ...
        beam.Position = UDim2.new(0.05 + (i * 0.38), 0, 0.35, 0)
...
-- INTRO ANİMASYONU (main.Visible TRUE iken)
-- ============================================================
local function PlayIntro(main, callback)
    -- main zaten görünür olmalı
...
local function CreateDarkGUI()
    -- PlayerGui kullan (CoreGui yerine)
    ...
    main.Parent = gui
    main.ZIndex = 999
    main.Visible = true   -- intro için görünür olsun
    MainFrame = main
    ...
    ConsoleLayoutRef = consoleLayout-- SIDEBAR (PC)
...
-- ============================================================
-- SAYFA İÇERİKLERİ (DÜZELTİLMİŞ)
-- ============================================================
local function UpdateContentPage(page)
    if PageTransitionActive then return end
    PageTransitionActive = true
    
    -- FADE OUT (sadece TextLabel/TextButton/TextBox için TextTransparency)
    ...
    elseif page == "CONSOLE" then
        ...
        task.wait(0.1)
        consoleScrollPage.CanvasSize = UDim2.new(0, 0, 0, consolePageLayout.AbsoluteContentSize.Y + 10)        elseif page == "STATUS" then
            -- STATUS SAYFASI
            local statusItems = {
...
print("   ✅ Line-art hamster (emoji yok)")
print("   ✅ Intro animasyonu")
print("   ✅ Smooth page transitions")
print("   ✅ PC/Mobile responsive")
print("   ✅ Modern toggle tasarımı")
print("   ✅ Terminal görünümlü konsol")
print("   ✅ Koyu tema + kırmızı accent")
print("   ✅ Hata toleranslı HTTP")
print("   ✅ Debug çıktıları")
print("========================================")
