-- ==============================================================================
-- LEA MOD V16.5 - PART 1 / 2 (CORE ENGINE, CUBE & OPTIMIZED FPS FIX)
-- ==============================================================================
...
-- Bypass sadece bir kez tetiklenir (FPS drop önlemi)
pcall(ApplyStrictBypass)
...
-- TARGET modu için optimize edilmiş gecikme sayacı
local targetTick = 0
...
RunService.Heartbeat:Connect(function(dt)
    ...
    -- TARGET (TAKİP) MODU (FPS Optimizasyonlu)  
    elseif State.Mode == "TARGET" then  
        targetTick = targetTick + dt
...
-- ==============================================================================
-- LEA MOD V16.5 - PART 2 / 2 (UI, TOGGLE MENÜ & İLERLETİLMİŞ KONUM)
-- ==============================================================================
...
function UI.Init()
    pcall(function()
        ...
        -- Sağ Üst Menü Aç/Kapat Butonu (Biraz Daha İleriye/Aşağıya Alındı)  
        ...
        -- Ana Menü Kutusu (Biraz Daha İleriye/Aşağıya Alındı)  
        local frame = Instance.new("Frame", sg)  
        frame.Size = UDim2.new(0, 115, 0, 260)  
        frame.Position = UDim2.new(1, -155, 0, 60)  
...
print("⭐ LEA MOD V16.5 - OPTİMİZE EDİLDİ VE YÜKLENDİ!")
-- ==============================================================================
-- LEA MOD V16.5 - PART 2 / 2 (UI, TOGGLE MENÜ & İLERLETİLMİŞ KONUM)
-- ==============================================================================
