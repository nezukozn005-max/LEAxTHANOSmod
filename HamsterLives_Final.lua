-- LocalScript
-- HAMSTER LIVES - HUD + V1 / V2 / V3 SEÇİCİ SİSTEM (WHITELIST'SİZ - HERKESE AÇIK)
-- Giriş: çapraz köşelerden birleşen 2 ışın -> HUD -> V1|V2|V3 sekmeleri
-- V1/V2 sunucu listeleme hataları düzeltildi: tek paylaşımlı tarayıcı, kalıcı liste, karışık sıralama
...
local BEAM_LENGTH = 70
local BEAM_THICKNESS = 7
local TRAVEL_TIME = 0.45
...
-- V1 / V2 / V3 kutucukları - animasyonlu, kaliteli
