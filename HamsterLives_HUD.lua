...
------------------------------------------------
local HUD_X_OFFSET = 0.58 -- ekranın %58'i - hafif sağa kaykık

local hudHolder = Instance.new("Frame")
hudHolder.Name = "HUD"
hudHolder.AnchorPoint = Vector2.new(0.5, 0)
hudHolder.Position = UDim2.new(HUD_X_OFFSET, 0, 0, 10)
hudHolder.Size = UDim2.fromOffset(230, 96)
hudHolder.BackgroundColor3 = Color3.fromRGB(8, 8, 10)
hudHolder.BackgroundTransparency = 0.15
...
hudCorner.Parent = hudHolder

local hudStroke = Instance.new("UIStroke")
hudStroke.Thickness = 2
hudStroke.Color = Color3.fromRGB(255, 0, 0)
hudStroke.Transparency = 0.2
hudStroke.Parent = hudHolder

-- Menü Aç/Kapa butonu (HUD'ın kendisine tıklanınca alt panel açılır/kapanır)
local hudToggle = Instance.new("TextButton")
hudToggle.Size = UDim2.new(1, 0, 0, 26)
hudToggle.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
hudToggle.Text = "☰ MENÜ AÇ/KAPA"
...
hudToggleCorner.CornerRadius = UDim.new(0, 10)
hudToggleCorner.Parent = hudToggle

-- Rol satırı (kozmetik rozet dahil)
local roleLabel = Instance.new("TextLabel")
roleLabel.Size = UDim2.new(1, -10, 0, 16)
roleLabel.Position = UDim2.new(0, 5, 0, 30)
roleLabel.BackgroundTransparency = 1
roleLabel.Text = hasSpecialRole and "ROL: HAMSTER" or "ROL: OYUNCU"
roleLabel.TextColor3 = hasSpecialRole and Color3.fromRGB(255, 210, 60) or Color3.fromRGB(180, 180, 180)
roleLabel.Font = Enum.Font.GothamBlack
roleLabel.TextSize = 13
roleLabel.ZIndex = 41
roleLabel.Parent = hudHolder

-- V1 / V2 / V3 sekme butonları (HUD'ın altında, küçük)
local tabHolder = Instance.new("Frame")
tabHolder.Size = UDim2.new(1, -10, 0, 22)
...
local function showHUD()
	...
	hudHolder.Size = UDim2.fromOffset(0, 0)
	TweenService:Create(hudHolder, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
