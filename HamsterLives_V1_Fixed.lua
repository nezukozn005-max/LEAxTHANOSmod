...
------------------------------------------------
-- WHITELIST
-- Yeni kişi eklemek için tabloya yeni UserId yaz.
------------------------------------------------
local WHITELIST = {
...
-- Whitelist dışında biri çalıştırırsa script burada durur.
...
local function V1_Build()
	...
	-- V1 taraması her V1 açılışında garanti şekilde başlasın.
	-- Eski tarama kapanırken yeni açılışın taramasını engellemesin.
	v1GuiAlive = true
...
local function openPanel()
	...
	-- İçeriği panel açılmadan önce kur; böylece ilk açılışta V1 boş kalmaz.
